...
class OrganisasiPolicy
{
    ...
    {
        return $user->can('force_delete_organisasi');
    }
    ...
    {
        return $user->can('force_delete_any_organisasi');
    }
    ...
    {
        return $user->can('restore_organisasi');
    }
    ...
    {
        return $user->can('restore_any_organisasi');
    }
    ...
    {
        return $user->can('replicate_organisasi');
    }
    ...
    {
        return $user->can('reorder_organisasi');
    }
}
